                                    ...
                                    @foreach ($invoices as $invoice)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="text-success">{{ $invoice->Status }}</div>
                                                @elseif($invoice->Value_Status == 2)
                                                <div class="text-danger">{{ $invoice->Status }}</div>
                                                @else
                                                <div class="text-warning">{{ $invoice->Status }}</div>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu tx-13">
                                                            ...
                                                            <a class="dropdown-item"
                                                            href="{{route('archiveinvoice',$invoice->id)}}">
                                                                <i class="text-warning fas fa-exchange-alt"></i> &nbsp;&nbsp;  ارشفة الفاتوره
                                                            </a>

                                                            <a class="dropdown-item"
                                                            href="{{route('invoiceprint',$invoice->id)}}">
                                                                <i class="text-success fas fa-print"></i> &nbsp;&nbsp;  طباعة الفاتوره
                                                            </a>
                                                    </div>
                                                </div>
                                            </td>
