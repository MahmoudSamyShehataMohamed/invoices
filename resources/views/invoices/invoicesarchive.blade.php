    ...
    <div class='row'>
        <div class="col-xl-12">
            ...
            <div class='messages'>
                ...
                @endif
                @if (Session::has('transferetoinvoices'))
                <script>
                    window.onload = function() {
                        notif({
                            msg: 'تم استعادة الفاتوره بنجاح',
                            type: "success"
                        })
                    }
                </script>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu tx-13">
                                                        ...
                                                        {{-- <a class="dropdown-item"
                                                            ...
                                                            <i class="text-danger fas fa-trash"></i> &nbsp;&nbsp;حذف
                                                            الفاتورة
                                                        </a> --}}
                                                        <a class="dropdown-item"
                                                        href="{{ route('formdeletearchiveinvoices', $invoice->id) }}">
                                                        <i class="text-danger fas fa-trash"></i> &nbsp;&nbsp;حذف
                                                        الفاتورة
                                                        </a>

                                                        <a class="dropdown-item"
                                                            href="{{ route('transfertoinvoices', $invoice->id) }}">
